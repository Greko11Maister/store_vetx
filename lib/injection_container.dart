...
import 'package:store_vtex/src/features/data/repositories/user_repository_impl.dart';
...
Future<void> init() async {
  //-> Use Cases
   ...
   sl.registerLazySingleton(() => OpenAccountUseCase(sl()));

   sl.registerLazySingleton(() => GetUserAccountIdUseCase(sl()));
