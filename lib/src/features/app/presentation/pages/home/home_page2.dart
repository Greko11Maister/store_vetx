...
class  HomePage2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    _controller = HomeController(getProductsAndSkuIdsUseCase: sl(), getProductIdUseCase: sl(), getCategoryLevelUseCase: sl());
        ...
        children: [
          ...
          GetBuilder<HomeController>(
            ...
            builder:(_) => Obx(()=> Row(
              ...
              children: _.category.map((e) =>  Container(
            ...
            builder: (_) => Obx(()=> Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (ctx, i)=> ProductItem(
                    onTap: ()=> Get.toNamed(ProductsPage.routeName, arguments: {
                      "productId": _.products[i].id
                    }),
                    p: _.products[i]),),
            )),
          ),
